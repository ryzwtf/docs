...
<Steps>
  <Step title="Locate Domain Manager Button">
    <Frame>
      ![Domain Manager Button](../images/domain-manager-01.png)
    </Frame>
  </Step>
  <Step title="Domain Manager Interface">
    Here you can see all available domains for the image host.
    <Frame>
      ![Domain Manager Button](../images/domain-manager-02.png)
    </Frame>
  </Step>
</Steps>
...
<Danger>
This feature is currently disabled due to issues with Vercel.
</Danger>
...
<Steps>
  ...
  <Step title="Start adding your domain">
    ...
    <Frame>
      ![Domain Configuration Popup](../images/Domain-Config-popup.png)
    </Frame>
  </Step>
  ...
  <Step title="Configure your DNS">
    ...
    <Frame>
      ![Cloudflare DNS Records](../images/cloudflarednsrecords.png)
    </Frame>
    ...
    <Frame>
      ![Add DNS Record](../images/domain-linker-add-record.png)
    </Frame>

    After this go back to your image-host dashboard and open back the pop-up by clicking “Open DNS Setup” in “Your Domains”.

    <Frame>
      ![Waiting for DNS Setup](../images/YourDomains-List-WaitingForDNSsetup.png)
    </Frame>
  </Step>
  ...
  <Step title="Verify your domain">
    ...
    <Frame>
      ![Verify Domain Button](../images/VerifyDomainButtonList.png)
    </Frame>

    If you see this then you're good to go !

    <Frame>
      ![Domain Linked Successfully](../images/YourDomains-List-Completed.png)
    </Frame>

    However if you got any error then please double check if u use Cloudflare that the record is DNS only and not proxied.

    <Frame>
      ![DNS Record DNS Only](../images/dns-record.png)
    </Frame>
